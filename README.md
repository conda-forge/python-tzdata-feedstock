...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/python-tzdata-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/python-tzdata-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add python-tzdata
# for installing globally
pixi global install python-tzdata
```
...
It is possible to list all of the versions of `python-tzdata` available on your platform:
...
```
pixi search python-tzdata --channel conda-forge
```
